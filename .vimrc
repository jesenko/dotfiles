...
" Key (re)Mappings {
    ...
    " Clear current search result higlight
...
" Plugins {
    ...
    " ctrlp {
        if isdirectory(expand("~/.vim/bundle/ctrlp.vim/"))
            ...
            let g:ctrlp_root_markers = [".ember-cli"]
    ...
    " splitjoin {
        " splitjoin does not add curly braces when splitting methods with keyword
        " arguments
        let g:splitjoin_ruby_curly_braceset = 0
    " }

    " syntastic {
        " syntastic checker also runs rubocop
